...
import { SecurityPolicy, SecuritySuite } from '../types';
...
describe('SecurityManager', () => {
    ...
    describe('initialization', () => {
        it('should initialize with security policy and suite', async () => {
            await expect(securityManager.initialize(
                SecurityPolicy.AUTH_ENCRYPTED,
    ...
    describe('encryption and decryption', () => {
        ...
        it('should throw error when trying to encrypt without initialization', async () => {
            const newManager = SecurityManager.getInstance();

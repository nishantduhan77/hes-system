import { MessageBrokerConfig } from '../services/MessageBrokerService';
import { CacheConfig } from '../services/CacheService';
import { DatabaseConfig } from './data-injection.config';
import { IngestConfig } from '../services/IngestService';
import { LoggingConfig } from '../services/LoggingService';
...
export const defaultConfig: ServicesConfig = {
    messageBroker: {
        mqtt: {

...
const DLMSSimulatorService_1 = require("../src/services/DLMSSimulatorService");
class MeterSimulationTester {
    constructor() {
        ...
        this.simulatorService = DLMSSimulatorService_1.DLMSSimulatorService.getInstance();
    }
    ...
    async checkRecentReadings(meters) {
    ...
    async validateDataQuality(meters) {
        ...
        for (const meter of meters) {
            ...
            console.log(`- Power variation coefficient: ${stats.avg_power > 0 ?
